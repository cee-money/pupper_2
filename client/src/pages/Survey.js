        ...
        <div className="container bg-active text-info">
          ...
          <form id="main-form">
            ...
            <div className="row">
              <div className="col-md-6 col-xs-12 form-group">
                ...
                <select
                  ...
                  id="q1"
                >
                  <SizeMenu name="size" onChange={this.handleInputChange} />
                </select>
              </div>
              <div className="col-md-6 col-xs-12 form-group">
            ...
            <div className="row">
              ...
              <div className="col-md-6 col-xs-12 form-group">
                <label for="q4">
                  My dogs favorite position is asleep on the couch.
                </label>
                <select
                  className="form-control form-group col-md-6 questions"
                  id="q4"
                >
                  <YesNoMenu name="lazy" onChange={this.handleInputChange} />
                </select>
              </div>
            </div>
            <div className="row">
              ...
              <div className="col-md-6 col-xs-12 form-group">
                <label for="q6">
                  My dog is skittish around large groups of dogs.
                </label>
                <select
                  className="form-control form-group col-md-6 questions"
                  id="q6"
            ...
            <div className="row">
              ...
              <div className="col-md-6 col-xs-12 form-group">
                <label for="q10">
                  My dog does not like to share their toys.
                </label>
                <select
                  className="form-control form-group col-md-6 questions"
                  id="q10"
            ...
            <div className="row">
              <div className="col-md-6 col-xs-12 form-group">
                ...
                <select
                  ...
                  id="q11"
                >
                  <YesNoMenu name="chaser" onChange={this.handleInputChange} />
                </select>
              </div>
              <div className="col-md-6 col-xs-12 form-group">
                <label for="q12">
                  My dog loves to wrestle with other dogs.
                </label>
                <select
                  className="form-control form-group col-md-6 questions"
                  id="q12"
            ...
            {this.state.dogName && this.state.url ? (
              <div className="row">
                <div className="col-md-1">
                  <SuccessModal />
                </div>
                <div className="col-md-1">
                  <a className="btn btn-info" href="/match" role="button">
                    Next
                  </a>
                </div>
              </div>
